 ...
 * 2018-11-24T20:07:52.490+08:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "sfkd",
                  wsdlLocation = "http://127.0.0.1:8888/ShunFengKuaiDi?wsdl",
                  targetNamespace = "http://impl.shunFengKuaiDi.it.yingxs.com/")
public class Sfkd extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.shunFengKuaiDi.it.yingxs.com/", "sfkd");
    public final static QName AddressInfoPort = new QName("http://impl.shunFengKuaiDi.it.yingxs.com/", "AddressInfoPort");
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:8888/ShunFengKuaiDi?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Sfkd.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:8888/ShunFengKuaiDi?wsdl");
        }
        WSDL_LOCATION = url;
    }
