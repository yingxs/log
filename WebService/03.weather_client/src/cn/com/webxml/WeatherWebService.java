 ...
 * 2018-11-27T20:46:33.175+08:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "WeatherWebService",
                  wsdlLocation = "file:/C:/Users/admin/Desktop/WeatherWebService.xml",
...
public class WeatherWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/admin/Desktop/WeatherWebService.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/admin/Desktop/WeatherWebService.xml");
        }
        WSDL_LOCATION = url;
    }
